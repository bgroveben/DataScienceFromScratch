...
def make_user_interest_vector(user_interests):
    """ given a list of interests, produce a vector whose i-th element """
...
if __name__=="__main__":
    ...
    print "Similar To: ", ["NoSQL", "MongoDB", "Cassandra", "HBase", "Postgres"]
    print most_popular_new_interests(["NoSQL", "MongoDB", "Cassandra", "HBase", "Postgres"])
    print
    print "Similar To: ", ["R", "Python", "statistics", "regression", "probability"]
    print most_popular_new_interests(["R", "Python", "statistics", "regression", "probability"])
    print

    print "User Based Similarity: "
    print "Most Similar to User 0: "
