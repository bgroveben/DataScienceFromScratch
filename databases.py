...
if __name__ == '__main__':
    ...
    average_friends_by_letter = users \
                                .select(additional_columns={'first_letter' : first_letter_of_name }) \
                                .group_by(group_by_columns=['first_letter'],
                                          aggregates={"average_num_friends" : average_num_friends },
                                          having=enough_friends)

    print "average_friends_by_letter: "
    print average_friends_by_letter
    print
    ...
    friendliest_letters = average_friends_by_letter \
                          .order_by(lambda row: -row["average_num_friends"]) \
                          .limit(4)
