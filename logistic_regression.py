...
if __name__=="__main__":
    ...
    for x_i, y_i in zip(x_test, y_test):
        ...
        if y_i == 1 and predict >= 0.5:  # TP: actual paid and predicted paid
            true_positives += 1
        elif y_i == 1:                   # FN actual paid and predicted unpaid
            false_negatives += 1
        elif predict >= 0.5:             # FP actual unpaid and predicted paid
            false_positives += 1
        else:                            # TN actual unpaid and predicted unpaid
            true_negatives += 1
