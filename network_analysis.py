...
print
print "Adjacency Matrix for Users: "
pp.pprint(adjacency_matrix)
print
eigenvector_centralities, _ = find_eigenvector(adjacency_matrix)
print "find_eigenvector(adjacency_matrix): "
pp.pprint(find_eigenvector(adjacency_matrix))
print
print "Eigenvector Centralities for Adjacency Matrix of Users: "
pp.pprint(eigenvector_centralities)
print
...
def page_rank(users, damping=0.85, num_iters=100):
    ...
    # this is the small fraction of PageRank where each node gets each iteration
